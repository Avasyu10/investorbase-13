  ...
  "inline-flex items-center rounded-full border px-2.5 py-1 text-xs font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        gold: 
          "bg-amber-600/90 text-amber-50 hover:bg-amber-600 border-transparent shadow-sm",
        green:
          "bg-green-600/90 text-green-50 hover:bg-green-600 border-transparent shadow-sm",
      },
    },
    defaultVariants: {
      variant: "default",
