...
export const SectionCard = ({
  ...
  return <Card className="cursor-pointer hover:shadow-lg transition-all duration-200 border-0 shadow-subtle hover:scale-105 h-full flex flex-col" onClick={onClick}>
      <CardHeader className="pb-3 flex-shrink-0 font-medium text-gray-50">
        ...
        <div className="relative">
          ...
          <div className={`absolute top-0 left-0 h-2 rounded-full transition-all ${getProgressColor(displayScore)}`} style={{
          width: `${progressValue}%`
        }} />
        </div>
      </CardHeader>
