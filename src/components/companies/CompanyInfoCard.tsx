  ...
  return <div className="mb-7">
      <div className="flex items-center justify-between mb-3">
        ...
        <div className="flex gap-2">
          ...
          {companyData?.id && isGeneralUser && <Button variant="outline" onClick={handleVCBot} size="sm" className="h-10 px-4 bg-yellow-500 text-zinc-950 hover:bg-yellow-600 shadow-md rounded-lg transition-all duration-200 ease-in-out">
