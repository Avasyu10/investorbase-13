...
serve(async (req) => {
  ...
  try {
    ...
    For the OVERALL ASSESSMENT - CRITICAL REQUIREMENT:
    - Generate EXACTLY 6-7 assessment points that HEAVILY integrate both answer quality AND comprehensive market data with specific numbers
    - Each point MUST include concrete market metrics such as: market size ($X billion), growth rates (X% CAGR), customer acquisition costs ($X), competitive landscape data, industry benchmarks, timing indicators with specific data points
    - Balance evaluation between what they understand (based on answers) and extensive market validation with dollar amounts, percentages, and comparative metrics
    - Include industry-specific data: market penetration rates, customer lifetime values, competitive spending data, regulatory impact costs, adoption timeline benchmarks
    - Every assessment point should seamlessly blend their response analysis with hard market numbers and industry statistics
...

    {
      ...
      "summary": {
        ...
        "assessment_points": ["This company shows strong potential for growth in their target market segment based on current industry trends valued at $X billion growing at X% CAGR, with their solution approach addressing key market gaps though customer acquisition costs averaging $X in this sector require careful consideration given the ${submission.company_name || 'company'}'s current stage.", "The founding team demonstrates relevant experience and domain expertise that aligns with successful startup patterns in this sector where teams with similar backgrounds achieve X% success rates, with market timing appearing favorable given the $X billion addressable market and X% annual growth in demand for this type of solution.", "The business model presents clear revenue opportunities and scalability potential in a market where successful companies typically achieve $X average revenue per customer and X% gross margins, though customer acquisition strategy requires validation against industry benchmarks of $X CAC and X-month payback periods for sustainable growth.", "Market size analysis indicates significant opportunity with the total addressable market estimated at $X billion and serviceable addressable market of $X billion, with industry growth rates of X% supporting early adoption scenarios while competitive positioning shows promise but needs strengthening against incumbents spending $X annually on market defense.", "Customer demand validation and competitive differentiation remain key areas for development, with market dynamics suggesting both opportunities in the growing $X billion sector and challenges including average customer acquisition costs of $X and competitive response investments typically ranging $X-X million in this industry.", "The execution plan demonstrates strategic thinking and milestone clarity, though resource requirements and timeline assumptions need market reality testing against industry benchmarks where similar companies require $X in funding and X months to achieve comparable milestones with X% success rates.", "Overall market assessment suggests this venture has potential for success with proper execution and market validation in an industry with $X billion market size growing at X% annually, requiring focused development in identified weak areas while leveraging favorable market conditions and timing."]
      }
    }

    Remember: Give EQUAL importance to both the applicant's actual answers AND relevant market data/industry insights. Generate EXACTLY 6-7 assessment points that are clean, natural statements without prefixes like "Assessment point 1" or "Assessment". Each assessment point MUST include specific market numbers, dollar amounts, growth rates, and industry metrics seamlessly integrated with answer evaluation. Each strength and weakness must integrate both aspects with specific data points and metrics. Significantly enhance weaknesses with more market data and competitive analysis. All scores must be on a 1-100 scale.
    `;
