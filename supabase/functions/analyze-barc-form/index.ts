  ...
  try {
...

    {
      ...
      "summary": {
        ...
        "assessment_points": ["This company shows strong potential for growth in their target market segment based on current industry trends and their solution approach, though market penetration costs need consideration given the ${submission.company_name || 'company'}'s current stage.", "The founding team demonstrates relevant experience and domain expertise that aligns with successful startup patterns in this sector, with market timing appearing favorable for this type of solution.", "The business model presents clear revenue opportunities and scalability potential, though customer acquisition strategy requires validation against industry benchmarks for sustainable growth.", "Market size analysis indicates significant opportunity with industry growth rates supporting early adoption scenarios, while competitive positioning shows promise but needs strengthening.", "Customer demand validation and competitive differentiation remain key areas for development, with market dynamics suggesting both opportunities and challenges ahead.", "The execution plan demonstrates strategic thinking and milestone clarity, though resource requirements and timeline assumptions need market reality testing.", "Overall market assessment suggests this venture has potential for success with proper execution and market validation, requiring focused development in identified weak areas."]
      }
    }

    Remember: Give EQUAL importance to both the applicant's actual answers AND relevant market data/industry insights. Generate EXACTLY 6-7 assessment points that are clean, natural statements without prefixes like "Assessment point 1" or "Assessment". Each strength and weakness must integrate both aspects with specific data points and metrics. Significantly enhance weaknesses with more market data and competitive analysis. All scores must be on a 1-100 scale.
    `;
